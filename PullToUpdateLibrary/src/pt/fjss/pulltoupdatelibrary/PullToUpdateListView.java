...
public class PullToUpdateListView extends ListView implements OnScrollListener {
	...
	private static String PULL_MESSAGE = "";
	private static String RELEASE_MESSAGE = "";
	private static String LOADING_MESSAGE = "";
...
//	private TextView headerMessage;
	private ImageView headerImageViewRotate;
//	private ImageView headerImage,headerImageViewRotate;
...
//		headerImage = (ImageView) mHeaderView.findViewById(R.id.headerImage);
		headerImageViewRotate=(ImageView) mHeaderView.findViewById(R.id.headerImageViewRotate);
...
//		footerProgressBar.setVisibility(View.GONE);
	...
	public void StartRotation(Boolean Condition){
		if(Condition){
...
//			headerImageViewRotate.startAnimation(rotateAnimation1);
//			headerImageViewRotate.setVisibility(View.VISIBLE);
		}else{
			headerImageViewRotate.setVisibility(View.GONE);
		}
	}
}
