...
public class WhatsHotParser extends DefaultHandler {
...
/*		if(qName.equalsIgnoreCase(EVENT_DETAIL)){
			...
			Bitmap bmp=downloadImage(mEvenItem.getVcImageUrl());
			Log.i("","Bitmap Image object : "+bmp);
			mEvenItem.setImageName(bmp);
