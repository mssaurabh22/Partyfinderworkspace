...
public class CardAdapter extends BaseAdapter{
	...
	public CardAdapter(Context ctx,ArrayList<Card> cardList,Activity act){
		mActivity=act;
		mContext=ctx;
		mCardList=cardList;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null){
			convertView=inflator.inflate(R.layout.user_credit_card_detail_item_layout, null);
			mViewHolder=new ViewHolder();
			mViewHolder.cardNumber=(TextView) convertView.findViewById(R.id.userCreditCardNo);
