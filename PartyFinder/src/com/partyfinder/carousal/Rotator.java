...
//    private float mCoeffVelocity = 0.06f;
...
//    
    ...
    private float mCoeffVelocity = 0.01f;
    private float mVelocity;
    
/* //   saurabh
    private float mCoeffVelocity = 0.04f;
    private float mVelocity;
    */
    ...
    private final float mDeceleration = 400.0f;
        ...
        if (timePassed < mDuration) {
        	switch (mMode) {
        		...
        		case FLING_MODE:
        			...
        			float timePassedSeconds = timePassed / 650.0f;     //saurabh 1000    			
        			float distance;

        			if(mVelocity < 0)
        			{
                    	distance = mCoeffVelocity * mVelocity * timePassedSeconds - 
                    	(mDeceleration * timePassedSeconds * timePassedSeconds / 100.0f);         //saurabh 2
        			}
        			else{
                    	distance = -mCoeffVelocity * mVelocity * timePassedSeconds - 
                    	(mDeceleration * timePassedSeconds * timePassedSeconds / 100.0f);        	//Saurabh 2			
